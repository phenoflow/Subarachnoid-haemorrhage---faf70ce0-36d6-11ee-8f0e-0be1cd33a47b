...
(async () => {
  ...
  await fs.writeFile("subarachnoid-haemorrhage-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("subarachnoid-haemorrhage-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
